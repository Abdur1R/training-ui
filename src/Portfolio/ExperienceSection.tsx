...
const ExperienceSection = () => (
    <div>
        <div className="note">
            <b>Note</b>: Below projects/features were built using react library on frontend and spring boot framework
            on backend.
        </div>
        <ul className="subBody">
            ...
            <li>
                Proficiently designed and developed module federated applications and microservices, contributing to the enhancement of application scalability and efficiency.
            </li>
        </ul>
    </div>
);

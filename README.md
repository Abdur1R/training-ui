...
If you are not able to deploy the code, change the branch in github-pages and save. Then, again revert it back to gh-pages and try 'npm run build' and 'npm run deploy' again!
